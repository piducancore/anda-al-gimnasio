...
exports.handler = async function (event, context) {
  ...
  if (login.resultado) {
    ...
    if (found) {
      ...
      return { body: `✅ ${found.descripcion}\n${found.nombre_profesor}\n${date}\n${time} horas`, statusCode: 200 };
    } else {
      return { body: "😢 No hay cupos disponibles", statusCode: 200 };
    }
  } else {
    return { body: "❌ Error de autenticación", statusCode: 401 };
  }
};
